...
STATE_FILE = str((Path(__file__).resolve().parent / "data" / "flowui_state.json"))
...
DOM_LIVE_DIR = ROOT_DIR / "scripts" / "dom" / "dom_live"
...
def build_pipeline_state() -> dict:
    ...
    capture_note = add_note_node("scripts/dom/dom_renderer/ai_recorder_live.py", x_capture_note, y_note_main, role="process")
    region_note = add_note_node("scripts/region_grow/region_grow/region_grow.py", x_region_note, y_note_main, role="process")
    rating_note = add_note_node("scripts/region_grow/numpy_rate/rating.py", x_action_note, y_note_main, role="process")
    brain_note = add_note_node("scripts/brain/pipeline_brain_agent.py\\nscripts/brain/pipeline_brain.py", x_brain_note, y_note_main, role="process")
    hover_note = add_note_node(
        "scripts/click/control_agent/control_agent.py\\n(+ scripts/click/recorder/hover_speed_recorder.py)",
        x_action_note,
