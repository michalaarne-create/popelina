...
DEFAULT_SPEED_PX_PER_S = 740.0      # docelowa średnia prędkość kursora w px/s
# Gap boost: lekkie, ale wyczuwalne przyspieszenie na „dziurach” między boxami.
# Niższa wartość => bardziej ludzko, mniej agresywne skoki.
DEFAULT_GAP_BOOST = 1.18            # ~18% szybciej w gapach zamiast 40% (1.4)
DEFAULT_LINE_JUMP_BOOST = 1.8       # miękkie przyspieszenie przy skokach między liniami
